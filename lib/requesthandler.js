...
method.get = function(params, callback, resource){
  ...
  if (this.__successor !== null) {
    ...
    var options = handleOptions('GET', uri, resource, query, headers);
    var req = handleRequest(options, deferred);
    req.end();
...
method.post = function(payload, callback, resource) {
  ...
  if (this.__successor !== null) {
    ...
    var options = handleOptions('POST',uri,resource, "", headers);
    var req = handleRequest(options, deferred);
    req.write(post_data);
    req.end();
    deferred.promise.nodeify(callback);
...
method.put = function(payload, callback, resource){
  ...
  if (this.__successor !== null) {
    ...
    var headers = handleAuthentication(this),
    uri = url.parse(this.url);
    var put_data = handlePayload(payload);
    headers['Content-Type'] = 'application/json';
    headers['Content-Length'] = put_data.length;
    var options = handleOptions('PUT',uri,resource,"",headers);
    var req = handleRequest(options, deferred);
    req.write(put_data);
    req.end();
    deferred.promise.nodeify(callback);
...
method.delete = function(params, callback, resource) {
    ...
    if (this.__successor !== null) {
      ...
      uri = url.parse(this.url);
      headers['Content-Type'] = 'application/x-www-form-urlencoded';
      var options = handleOptions('DELETE',uri, resource,query, headers);
      var req = handleRequest(options, deferred);
      req.end();
      deferred.promise.nodeify(callback);
      return deferred.promise;
...
function handleOptions(method, uri, resource, query, headers){
  return {
